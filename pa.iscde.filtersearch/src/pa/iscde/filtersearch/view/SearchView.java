...
public class SearchView implements PidescoView {
	...
	public SearchView() {
		...
		/**
		 * Acede aos pontos de extens�o que implementam a interface SearchProvider
		 */
	...
	public void createContents(Composite viewArea, Map<String, Image> images) {
		...
		// Listener de altera��es no searchText
	...
	/**
	 * Decide o que vai aparecer em cada item da �rvore: nome e imagem
	 * @author lcmms
	 *
	 */
	...
	/**
	 * Define que elementos v�o aparecer na �rvore
	 * @author lcmms
	 *
	 */
