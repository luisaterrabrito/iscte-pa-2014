...
public class CommandKey {
	...
	public CommandKey(String name, String view, boolean ctrl_key, boolean alt_key, char key){
	...
	@Override
	public int hashCode(){
		return ((short) view.hashCode()) ^ ((short) Boolean.valueOf(ctrl_key).hashCode()) ^ ((short) Boolean.valueOf(alt_key).hashCode()) ^ ((short) Character.valueOf(key).hashCode());
	}
	...
	public boolean equals(Object o){
		...
		if(view.equals(command.view) && ctrl_key == command.ctrl_key && alt_key == command.alt_key && key == command.key)
			return true;
