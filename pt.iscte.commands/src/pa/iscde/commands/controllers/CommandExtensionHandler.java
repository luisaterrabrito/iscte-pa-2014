...
public class CommandExtensionHandler implements Handler {
	...
	enum TypesOfCommand { command_view, command_editor }
	...
	public void processExtension(IConfigurationElement e)
		...
		if(replacedValue != null)
			System.err.println("WARNING: While loading the commands extensions, the command with the name '" + 
					replacedValue.getCommandKey().getCommandName() + "' got replaced by the new command '"+ name + "',  "
