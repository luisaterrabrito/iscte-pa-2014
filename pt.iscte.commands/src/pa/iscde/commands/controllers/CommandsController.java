...
import pa.iscde.commands.features.actions.CommandKeyListener;
...
public class CommandsController implements BundleActivator {
	...
	public void stop(BundleContext context) throws Exception {
		ViewWarehouse.setContext(null);
		ViewWarehouse.eraseModel();
		CommandWarehouse.eraseModel();
		
		
		KeyPressDetector.getInstance().removeKeyPressListener(commandKeylistener);
