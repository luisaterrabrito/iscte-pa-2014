 ...
 * 
 * @author David Franco & Jo�o Gon�alves
 * @version 01.00
 */
public class DocumentationView implements PidescoView {
	...
	private String toHTML() {
		...
		if(objectDoc.getName() != null){
			...
			//erro ocorre (não instanciar o objectDoc) ao criar um novo objecto da classe Scanner em JavaEditorServicesImpl (private String readSource(File file))
			sb.append("<br><font size='6'> Ocorreu um erro ao tentar gerar a documentação. Edite o conteúdo do ficheiro e faça save </font>");
		}
